...
@unittest.skipUnless(settings.ROOT_URLCONF == 'lms.urls', 'Test only valid in the LMS.')
class IssueProgramCertificatesViewTests(TestCase, ProgramsApiConfigMixin):
    ...
    def setUp(self):
        ...
        self.path = reverse('programs:v1:certify')
    ...
    def _verify_response(self, status_code):
        ...
        with mock.patch('openedx.core.djangoapps.programs.api.v1.views.award_program_certificates.delay') as mock_task:
