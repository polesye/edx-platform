    ...
    function($) {
        ...
        describe('edx.dashboard.trackEvents', function() {
            ...
            it('sends an analytics event when the user clicks course title link', function() {
                ...
                window.edx.dashboard.trackCourseTitleClicked($courseTitle, window.edx.dashboard.generateTrackProperties);
            ...
            it('sends an analytics event when the user clicks course image link', function() {
                ...
                window.edx.dashboard.trackCourseImageLinkClicked($courseImage, window.edx.dashboard.generateTrackProperties);
            ...
            it('sends an analytics event when the user clicks enter course link', function() {
                ...
                window.edx.dashboard.trackEnterCourseLinkClicked($enterCourse, window.edx.dashboard.generateTrackProperties);
            ...
            it('sends an analytics event when the user clicks enter course link', function() {
                ...
                window.edx.dashboard.trackCourseOptionDropdownClicked($dropDown, window.edx.dashboard.generateTrackProperties);
            ...
            it('sends an analytics event when the user clicks the learned about verified track link', function() {
                ...
                window.edx.dashboard.trackLearnVerifiedLinkClicked($learnVerified, window.edx.dashboard.generateTrackProperties);
            ...
            it('sends an analytics event when the user clicks the \'View XSeries Details\' button', function() {
                ...
                window.edx.dashboard.trackXseriesBtnClicked($xseries, window.edx.dashboard.generateProgramProperties);
                expect(window.analytics.trackLink).toHaveBeenCalledWith(
                    $xseries,
